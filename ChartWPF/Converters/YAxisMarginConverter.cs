...
{
    class YAxisMarginConverter : IMultiValueConverter
    {
        ...
        {
            Thickness result = new Thickness(0d);

            if (values != null &&
                values.Length == 2)
            {
                Thickness value1 = new Thickness(5d);
                Thickness value2 = (Thickness)values[1];

                result = new Thickness(value1.Left + value2.Left,
